...
app.controller('projectsController', function projectsController($scope,$modal,projectsFactory,$http,$resource,$log){
	...
	var deleteModalController = function ($scope, $modalInstance,deleteproject) {
		$scope.projects = deleteproject;
		$scope.selected = {
		item: $scope.items[0]
			};
